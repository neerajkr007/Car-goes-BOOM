...
public class TopDownCarController : MonoBehaviour
{
    ...
    //Components
    Rigidbody carRigidbody2D;

    //Awake is called when the script instance is being loaded.
    void Awake()
    {
        carRigidbody2D = GetComponent<Rigidbody>();
    }
    ...
    void ApplyEngineForce()
    {
        ...
        carRigidbody2D.AddForce(engineForceVector, ForceMode.Force);
    }
    ...
    void ApplySteering()
    {
        ...
        carRigidbody2D.MoveRotation(Quaternion.Euler(new Vector3(0f, rotationAngle, 0f)));
    }
